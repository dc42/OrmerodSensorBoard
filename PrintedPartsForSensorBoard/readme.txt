...
2. Modified heatsink duct. This includes the mounting points for the sensor board. Alternatively you can use Matt's one piece hotend duct. The files are here:
...
3. Insulator. This prevents the board from shorting against the z-threaded rod or other metal parts if the print head moves beyond the intended x-homing position. Alternatively you can use Kim brown's safety cover, the files are here:
